const injectedButton = document.getElementById("injected-button");

injectedButton.addEventListener("click", (link) => {
  link.preventDefault();

  titleContent.innerHTML = "Finalizados";
  divDataTables.innerHTML = "";

  data.forEach((object => {

    if(object.estadot == "finalizado"){
