...
homeButton.addEventListener("click", (link) => {
  link.preventDefault();
  titleContent.innerHTML = "Inicio";
  divDataTables.innerHTML = "";
  data.forEach((object) => {
        if(object.estadot == null || object.estadot == ''){
            ...
            date = new Date(object.horacreado).toLocaleDateString(
              "es-ES",
              options
            );
